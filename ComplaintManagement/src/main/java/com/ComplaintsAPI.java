...
public class ComplaintsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = complaintObj.insertComplaint(request.getParameter("complainerName"),
				request.getParameter("email"),
				request.getParameter("phoneNumber"),
				request.getParameter("complaintCategory"),
				request.getParameter("complaint"),
				request.getParameter("issueArea"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException
		{
			...
			paras.get("complainerName").toString(),
			paras.get("email").toString(),
			paras.get("phoneNumber").toString(),
			paras.get("complaintCategory").toString(),
			paras.get("complaint").toString(),
			paras.get("issueArea").toString(),
